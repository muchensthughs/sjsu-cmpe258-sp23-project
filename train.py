...
def main():
    ...
    # Creating objects, loading weights, and setting up the models 
    ...
    # define training and validation step functions
    ...
    for epoch in range(TRAIN_EPOCHS):
        ...
        # writing average loss over entire validation set
